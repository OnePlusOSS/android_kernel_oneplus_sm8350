				 ...
				 struct device_node *of_node)
{
	...
	if (ret) {
		...
		CAM_ERR(CAM_OIS, "get ois_gyro,type failed rc:%d, default %d", ret,
	...
	if (ret)
		CAM_ERR(CAM_OIS, "get ois,name failed rc:%d, set default value to %s", ret,
			o_ctrl->ois_name);
	...
	if (ret) {
		...
		CAM_ERR(CAM_OIS, "get ois_module,vendor failed rc:%d, default %d", ret,
	...
	if (ret) {
		...
		CAM_ERR(CAM_OIS, "get ois_actuator,vednor failed rc:%d, default %d", ret,
