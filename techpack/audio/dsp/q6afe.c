...
int send_tfa_cal_apr(void *buf, int cmd_size, bool bRead, int mi2s_id)
{
	...
	port_id = tfa_get_port_id(mi2s_id, AFE_PORT_RX);
...
int send_tfa_cal_in_band(void *buf, int cmd_size, int mi2s_id)
{
	union afe_spkr_prot_config afe_spk_config;
...
int send_tfa_cal_set_bypass(void *buf, int cmd_size, int mi2s_id)
{
	union afe_spkr_prot_config afe_spk_config;
	int32_t port_id = AFE_PORT_ID_TFADSP_RX;
...
int send_tfa_cal_set_tx_enable(void *buf, int cmd_size, int mi2s_id)
{
	union afe_spkr_prot_config afe_spk_config;
	...
	port_id = tfa_get_port_id(mi2s_id, AFE_PORT_TX);
	if (afe_spk_prot_prepare(port_id, 0,
