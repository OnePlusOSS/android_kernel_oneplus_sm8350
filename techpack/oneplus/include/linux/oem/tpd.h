...
extern int tpd_suggested(struct task_struct* tsk, int request_cpu);
...
static inline int tpd_suggested(struct task_struct* tsk, int request_cpu) { return request_cpu; }
