...
** ---------------------------------------------------------------
**	LianGenglin	2020/05/09	1.0			 build this module
**	LiYi		2020/06/01	2.0			 modify this module
**
************************************************************************************/
...
static int oplus_dhcp_netlink_init(void)
{
	...
	return !oplus_dhcp_sock ? -ENOMEM : 0;
}
...
static int oplus_dhcp_hooks_sysctl_init(void)
{
	...
	return !oplus_dhcp_hooks_table_hrd ? -ENOMEM : 0;
}
