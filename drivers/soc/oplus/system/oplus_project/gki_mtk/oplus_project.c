...
/*xtern ProjectInfoCDTType_oldcdt *format;*/
...
static void init_project_version(void)
{
	...
	if (np) {
		...
		if (g_project->nDataBCDT.ProjectNo < 100000) {
			pr_err("KE new cdt newcdt:%d nVersion:%d Project:%d,
				 Dtsi:%d, Audio:%d, nRF:%d, PCB:%d Feature0-9:
					%d %d %d %d %d %d %d %d %d %d eng_version:
						%d confidential:%d\n",
			       newcdt,
			       g_project->Version,
			...
			pr_err("KE new cdt newcdt:%d nVersion:%d Project:%X, Dtsi:%X,
				 Audio:%X, nRF:%d, PCB:%d Feature0-9:
					%d %d %d %d %d %d %d %d %d %d eng_version:%d confidential:%d\n",
			       newcdt,
			       g_project->Version,
			       g_project->nDataBCDT.ProjectNo,
			       g_project->nDataBCDT.DtsiNo,
