...
enum {
	...
	IM_ID_KSWAPD,              // kswapd, (prefix)
	IM_ID_HEAPTASKDAEMON,      // heaptaskdaemon
	IM_ID_DEX2OAT,             // dex2oat
	IM_ID_MAX
};
...
#define IM_KSWAPD         (1 << IM_ID_KSWAPD)
#define IM_HEAPTASKDAEMON (1 << IM_ID_HEAPTASKDAEMON)
#define IM_DEX2OAT        (1 << IM_ID_DEX2OAT)
...
static inline void im_to_str(int flag, chari *desc, int size) {}
