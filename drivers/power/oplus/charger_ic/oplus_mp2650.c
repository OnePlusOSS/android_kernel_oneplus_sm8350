...
int __attribute__((weak)) oplus_warpphy_enable(bool enable)
{
	return 0;
}

int __attribute__((weak)) oplus_warpphy_reset_again(void)
{
	return 0;
}
...
void __attribute__((weak)) oplus_chg_set_curr_level_to_warpphy(void)
{

}

void __attribute__((weak)) oplus_chg_set_match_temp_to_warpphy(void)
{
...
int mp2650_set_vindpm_vol(int vol)
{
    int rc;
    int tmp = 0;
...
int mp2650_otg_enable(void)
{
	...
	mp2650_set_wdt_timer(REG09_MP2650_WTD_TIMER_DISABLE);
	mp2650_config_interface(REG53_MP2650_ADDRESS, 0x95, 0xff);
	mp2650_config_interface(REG3F_MP2650_ADDRESS, 0x20, 0xff);
	...
	msleep(10);
	mp2650_config_interface(REG3F_MP2650_ADDRESS, 0x00, 0xff);
	mp2650_config_interface(REG53_MP2650_ADDRESS, 0x00, 0xff);
